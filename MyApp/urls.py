...
urlpatterns = [
    ...
    path('v1/user', views.GetOneUser.as_view(), name="getOneUser"),
    ...
    path('v1/loginJWT', views.LoginJWT.as_view(), name="loginJWT"),
    path('v1/logout', views.LogoutJWT.as_view(), name="logout"),
]
